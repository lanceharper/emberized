...
function program1(depth0,data) {
  ...
  stack2 = ((stack1 = helpers.linkTo),stack1 ? stack1.call(depth0, "stack", "", options) : helperMissing.call(depth0, "linkTo", "stack", "", options));
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("</li>\n");
  return buffer;
  }
...
helpers = helpers || Ember.Handlebars.helpers; data = data || {};
  ...
  data.buffer.push("</h3>\n\n");
  hashTypes = {};
  data.buffer.push(escapeExpression(helpers.log.call(depth0, "", {hash:{},contexts:[depth0],types:["ID"],hashTypes:hashTypes,data:data})));
  return buffer;
